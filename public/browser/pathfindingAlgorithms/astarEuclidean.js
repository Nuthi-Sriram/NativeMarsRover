function astarEuclidean(nodes, start, target, nodesToAnimate, boardArray, name, heuristic) {
  ...
  function updateNode(currentNode, targetNode, actualTargetNode, name, nodes, actualStartNode, heuristic, boardArray) {
    ...
    if (!targetNode.heuristicDistance) targetNode.heuristicDistance = euclidean(targetNode, actualTargetNode);
  ...
  function euclidean(nodeOne, nodeTwo) {
