function astarChebyshev(nodes, start, target, nodesToAnimate, boardArray, name, heuristic) {
  ...
  function updateNode(currentNode, targetNode, actualTargetNode, name, nodes, actualStartNode, heuristic, boardArray) {
    ...
    if (!targetNode.heuristicDistance) targetNode.heuristicDistance = chebyshev(targetNode, actualTargetNode);
  ...
  function chebyshev(nodeOne, nodeTwo) {
    ...
    return Math.max(xChange,yChange);
  }
  
  
  
  module.exports = astarChebyshev;
